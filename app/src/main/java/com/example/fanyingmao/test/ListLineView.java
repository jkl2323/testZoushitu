...
/**
 * Created by  on 2017/car_3/car_8.
 */
...
public class ListLineView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        System.out.println("测试高度:"+this.heightMeasureSpec);
...
//                System.err.println("up:"+up.toString());
//            }
//            if (down != null) {
//                canvas.drawLine(down.x, down.y, current.x, current.y, mPainLine);
//                System.err.println("down:"+down.toString());
//            }
            Path path1 = new Path();
            ...
            if(up != null && down != null){
                ...
                System.err.println("跨域画线: up.x:"+up.x+"up.y:"+up.y+" down.x:"+down.x+" down.y"+down.y);
            }
        }
